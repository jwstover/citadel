defmodule Citadel.Accounts do
  ...
  tools do
    tool :get_current_workspace, Citadel.Accounts.Workspace, :current do
      description "Returns the workspace associated with the current API key session. Example call: get_current_workspace({}) — takes no args; do NOT pass an \"input\" wrapper."
    end
  end
