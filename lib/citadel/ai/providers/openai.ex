defmodule Citadel.AI.Providers.OpenAI do
  @moduledoc """
  OpenAI AI provider implementation.

  This module implements the Citadel.AI.Provider behavior for OpenAI's
  models (GPT-4, GPT-3.5, etc.) using the LangChain library.
  """
  ...
  def validate_config(_config) do
    {:error, "Invalid OpenAI configuration: api_key is required"}
  end
  ...
  defp default_error_message(400) do
    "Invalid request (400). Please check your request parameters."
  end
